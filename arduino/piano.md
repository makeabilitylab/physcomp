...
Note that the tone call returns immediately—almost like an asynchronous call in a multi-threaded program would. However, the Arduino Uno is a single-core chip with no multi-threading support. So, how does this work? Via timer interrupts.
