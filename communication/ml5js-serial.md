...
First, let's start with some background on machine learning frameworks before diving into building with [ml5.js](https://ml5js.org/).
...
You can try out the application [here](https://learn.ml5js.org/#/reference/posenet) ([live page](https://learn.ml5js.org/#/reference/posenet), [code](https://github.com/makeabilitylab/p5js/tree/master/ml5js/PoseNet/Skeleton)).
